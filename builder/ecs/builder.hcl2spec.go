...
type FlatConfig struct {
	...
	ProjectName               *string           `mapstructure:"project_name" required:"false" cty:"project_name"`
	ProjectID                 *string           `mapstructure:"project_id" required:"false" cty:"project_id"`
	IdentityEndpoint          *string           `mapstructure:"auth_url" required:"false" cty:"auth_url"`
	...
	SourceImage               *string           `mapstructure:"source_image" required:"false" cty:"source_image"`
	SourceImageName           *string           `mapstructure:"source_image_name" required:"false" cty:"source_image_name"`
	SourceImageFilters        *FlatImageFilter  `mapstructure:"source_image_filter" required:"false" cty:"source_image_filter"`
