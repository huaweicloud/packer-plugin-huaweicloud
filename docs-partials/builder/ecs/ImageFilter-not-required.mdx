<!-- Code generated from the comments of the ImageFilter struct in builder/ecs/run_config.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the ImageFilter struct in builder/ecs/run_config.go; -->
